...
import com.example.nikeshop.Presenter.PresenterLoginFragment
...
class LoginFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        btn_login_fragment.setOnClickListener {
            ...
            if (testField()) {
                apiService.getApi()
                    .userLogin(
                        editText_email_login_fragment.text.toString(),
                        editText_password_login_fragment.text.toString()
    ...
    private fun testField(): Boolean {
        ...
        if (editText_email_login_fragment.text.toString()
                .isEmpty() || editText_password_login_fragment.text.toString().isEmpty()
        ) {
